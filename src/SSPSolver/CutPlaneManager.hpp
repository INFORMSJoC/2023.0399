...
class CPM{
  ...
  CPM(GRBModel*& model, GRBVar*& vars, const int& N, bool& bounded, const vi& weights, const vi& freq,
   const vi& wToIt, const vi& ids, const vd& primal, const vll& dual, const vector<vd>& afim,
